...
# drugA
full2A = glm(success ~., data = data_vs2A, family = "binomial")
...
summary(back2A) # formula = success ~ provoked + se_group
summary(both2A) # formula = success ~ provoked + se_group
...
```{r}
pred = glm(success ~ drug+ age_group+gender+provoked+homemed+se_group+benzonum+drug*age_group
